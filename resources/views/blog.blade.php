        ...
        <div class="row">
                ...
                <article class="post-container">
                    <div class="post-thumb">
                        <a href="blog-post.html" class="d-block position-relative overflow-hidden">
                            <img src="{{asset('assets/img/blog/blog-post-1.jpg')}}" class="img-fluid" alt="Blog Post">
                        </a>
                    </div>
                ...
                <article class="post-container">
                    <div class="post-thumb">
                        <a href="{{url('blog-post')}}" class="d-block position-relative overflow-hidden">
                            <img src="{{asset('assets/img/blog/blog-post-2.jpg')}}" class="img-fluid" alt="">
                        </a>
                    </div>
                    <div class="post-content">
                        <div class="entry-header">
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-4 mb-30">
                <article class="post-container">
                    <div class="post-thumb">
                        <a href="{{url('blog-post')}}" class="d-block position-relative overflow-hidden">
                            <img src="{{asset('assets/img/blog/blog-post-3.jpg')}}" class="img-fluid" alt="">
                        </a>
                    </div>
                    <div class="post-content">
                        <div class="entry-header">
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-4 mb-30">
                <article class="post-container">
                    <div class="post-thumb">
                        <a href="{{url('blog-post')}}" class="d-block position-relative overflow-hidden">
                            <img src="{{asset('assets/img/blog/blog-post-4.jpg')}}" class="img-fluid" alt="">
                        </a>
                    </div>
                    <div class="post-content">
                        <div class="entry-header">
            ...
            <div class="col-12 col-md-6 col-lg-6 col-xl-4 mb-30">
                <article class="post-container">
                    <div class="post-thumb">
                        <a href="{{url('blog-post')}}" class="d-block position-relative overflow-hidden">
                            <img src="{{asset('assets/img/blog/blog-post-5.jpg')}}" class="img-fluid" alt="">
                        </a>
                    </div>
                    <div class="post-content">
                        <div class="entry-header">
